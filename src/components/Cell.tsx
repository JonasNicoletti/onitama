import { GridItem, Center, Icon } from "@chakra-ui/react";
import { Piece, Turn } from "../types";

export function Cell({ x, y, isSelected, isPossibileMove, pieceType, turn, onClick }: { x: number, y: number, isSelected: boolean, isPossibileMove: boolean, pieceType?: Piece, turn: Turn, onClick: (key: string) => void }) {
